...
class FusionCamera():
    ...
    def __init__(self):
        ...
        self.visible_camera = VideoGear(source=self.video_source, stabilize=False).start()
        self.thermal_camera = VideoGear(source=self.video_source1, stabilize=False).start()
